...
#define STRING_CONFIG_H_AUTHOR "Christian Coello Grassi" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Custom Hellbot Magna Dual"
//#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "abd66b7c-7a79-4a52-a6df-3657a96c0caa"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 179.29
  #define DEFAULT_BED_KI 32.51
  #define DEFAULT_BED_KD 659.27
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 400, 410.2 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10000, 10000, 1000, 20000 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.200 // (mm) Distance from real junction edge //CCG default 0.013
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -32.5, -5.5, -1 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define PROBE_OFFSET_ZMAX  40   // (mm)
